...
if __name__ == '__main__':
    ...
    parser.add_argument('-src', '--source', dest='video_source', 
                        default='rtmp://localhost/live/djidrone', help='Video stream address of the camera.')
    ...
    if not video_capture:
        print("[ERR] Failed VideoCapture: invalid parameter!")
